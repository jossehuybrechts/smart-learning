...
rag_template = ChatPromptTemplate.from_messages(
    [
        (
            ...
            After the exercise, display a score indicating the difficulty level of the question. Use a scale of 1 to 5, where 1 is very easy and 5 is very difficult. Display the difficulty as follows: Difficulty: "(Difficulty)/5".
